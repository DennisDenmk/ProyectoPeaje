...
<body>
    ...
    <main class="principal">
        <article class="explicacion">
            <p id="explicacion">
                Descubra nuestra gama de servicios diseñados para ofrecer soluciones de peaje eficientes y sin
                complicaciones:
                <br>
                1.-Peaje Electrónico: Disfrute de un tránsito fluido con nuestro servicio de peaje electrónico, que
                permite a los vehículos pasar sin detenerse gracias a la tecnología de identificación automática.
                <br>
